\begin{figure}[ht]
    ...
    \resizebox{0.9\textwidth}{!}{
        \begin{tikzpicture}[
            ...
            \draw[<->] (object) -- node[right, font=\small\itshape, red!70!black] {Primary Contradiction} (division);

            \draw[<->] (instruments) -- (community);

            \draw[<->] (rules) -- (community);
            \draw[<->] (community) -- node[below, font=\small\itshape, red!70!black, align=center] {Insufficient support\\within students' ZPD} (division);
