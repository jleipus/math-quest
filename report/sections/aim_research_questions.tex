...
\begin{description}
    ...
    \item [RQ3:] How can the ``MiniGuide''~\cite{lithner2025miniguide} pedagogical strategy enable the system's generation logic to ensure that AI responses provide transparent guidance rather than direct answers?
