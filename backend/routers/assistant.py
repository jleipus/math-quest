...
from backend.models.assistant import AnalysisResponse, AnalysisRequest, Stroke
...
def analyse(payload: AnalysisRequest) -> AnalysisResponse:
    ...
    return llm_service.analyse_student_work(task.question, image_png)
